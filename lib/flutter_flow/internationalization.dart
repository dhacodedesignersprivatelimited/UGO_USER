...
final kTranslationsMap = <Map<String, Map<String, String>>>[
  ...
  // Set_Location
  {
    'fu9b0xkt': {
      ...
      'hi': 'अपना पिकअप स्थान निर्धारित करें',
      'te': 'మీ పికప్ పాయింట్‌ను సెట్ చేయండి',
    },
    'oyq430f9': {
      'en': 'Drag map to move pin',
      'hi': 'पिन ले जाने के लिए मानचित्र खींचें',
      'te': 'పిన్ తరలించడానికి మ్యాప్‌ని లాగండి',
    },
    '20avd2zk': {
      'en': 'Akshya Patra restaurant',
      'hi': 'अक्षय पात्र रेस्टोरेंट',
      'te': 'అక్షయ పాత్ర రెస్టారెంట్',
    },
    'zjwcs591': {
      'en': 'Confirm pickup',
      'hi': 'पिकअप की पुष्टि करें',
      'te': 'పికప్‌ని నిర్ధారించండి',
    },
    'enofnqm4': {
      'en': 'Home',
      'hi': 'घर',
  ...
  // ridecomplet
  {
    'w7o09tep': {
      ...
      'hi': 'भरत के साथ आपकी यात्रा समाप्त हो गई है',
      'te': 'భారత్‌తో మీ ప్రయాణం ముగిసింది',
    },
    'e1pwahtk': {
      'en': 'Trip ID: 1234567890',
      'hi': 'यात्रा आईडी: 1234567890',
      'te': 'ట్రిప్ ID: 1234567890',
    },
    'itezhxm9': {
      'en': 'Driver',
      'hi': 'चालक',
    ...
    '5nwjd2yc': {
      'en': 'Rate Your Ride',
      'hi': 'अपनी सवारी को रेट करें',
      'te': 'మీ రైడ్‌ను రేట్ చేయండి',
    },
    '6fi1td6j': {
      'en': 'Report a problem',
      'hi': 'एक समस्या की रिपोर्ट करें',
    ...
    '7kp58c7y': {
      ...
      'hi': 'यात्रा विवरण साझा करें',
      'te': 'ట్రిప్ వివరాలను షేర్ చేయండి',
    },
    'tpgp8z97': {
      'en': 'Tip Driver (Optional)',
      'hi': 'ड्राइवर को टिप दें (वैकल्पिक)',
      'te': 'డ్రైవర్‌కు టిప్ ఇవ్వండి (ఐచ్ఛికం)',
    },
    '2rzn0mym': {
      'en': '\$2',
      'hi': '\$2',
    ...
    '02dtdzvc': {
      ...
      'hi': 'अपने पिछले स्थान को फिर से बुक करें',
      'te': 'మీ చివరి స్థానాన్ని మళ్లీ బుక్ చేయండి',
    },
    'smz87xjz': {
      'en': 'Save this drop location',
      'hi': 'इस ड्रॉप स्थान को सहेजें',
      'te': 'ఈ డ్రాప్ లొకేషన్‌ను సేవ్ చేయండి',
    },
    'byt66rmt': {
  ...
  // reviews
  {
    ...
    'rpt36sv1': {
      ...
      'hi': 'मार्ग: 123 मेन सेंट से 456 ओक एवेन्यू',
      'te': 'మార్గం: 123 మెయిన్ సెయింట్ నుండి 456 ఓక్ అవెన్యు',
    },
    'if0a8nrr': {
      'en': 'Rate Your Trip',
      'hi': 'अपनी यात्रा को रेट करें',
      'te': 'మీ ట్రిప్‌ని రేట్ చేయండి',
    },
    'a00tj7z9': {
      'en': '1 Star\" \\ \"2 Stars\" \\ \"3 Stars\" \\ \"4 Stars',
      'hi': '1 स्टार\" \\ \"2 स्टार\" \\ \"3 स्टार\" \\ \"4 स्टार',
      'te': '1 స్టార్\" \\ \"2 స్టార్\" \\ \"3 స్టార్\" \\ \"4 స్టార్',
    },
    'd95i27h2': {
      'en': '5 Stars',
      'hi': '5 स्टार',
    ...
    'lg5on7em': {
      ...
      'hi': 'अनुकूल\" \\ \"सुरक्षित\" \\ \"सबसे खराब\" \\ \"तेज़',
      'te': 'స్నేహపూర్వక\" \\ \"సురక్షితమ్\" \\ \"అతి దారుణం\" \\ \"వేగంగా',
    },
    'lw2hpxv7': {
      'en': 'Affordable',
      'hi': 'किफ़ायती',
    ...
    'a2jbhg9r': {
      ...
      'hi': 'अपनी टिप्पणियाँ जोड़ें...',
      'te': 'మీ వ్యాఖ్యలను జోడించండి...',
    },
    'wdtlzwwe': {
      'en': 'Add Photos',
      'hi': 'फ़ोटो जोड़ें',
  ...
  // Custom Keys
  {
    ...
    'login_welcome_back': {
      'en': 'Welcome back! You\'re logged in.',
      'hi': 'वापसी पर स्वागत है! आप लॉग इन हैं।',
      'te': 'తిరిగి స్వాగతం! మీరు లాగిన్ అయ్యారు.',
    },
    'ride_cancelled_success': {
      'en': 'Ride cancelled successfully',
      'hi': 'सवारी सफलतापूर्वक रद्द कर दी गई',
      'te': 'రైడ్ విజయవంతంగా రద్దు చేయబడింది',
    },
    'ride_cancel_fail': {
      'en': 'Failed to cancel ride.',
      'hi': 'सवारी रद्द करने में विफल।',
      'te': 'రైడ్ రద్దు చేయడంలో విఫలమైంది.',
    },
    'ride_cancel_confirm_title': {
      'en': 'Cancel Ride?',
      'hi': 'सवारी रद्द करें?',
      'te': 'రైడ్ రద్దు చేయాలా?',
    },
    'ride_cancel_confirm_content': {
      'en': 'Are you sure you want to cancel this ride?',
      'hi': 'क्या आप वाकई इस सवारी को रद्द करना चाहते हैं?',
      'te': 'మీరు ఖచ్చితంగా ఈ రైడ్‌ను రద్దు చేయాలనుకుంటున్నారా?',
    },
    'common_no': {
      'en': 'No',
      'hi': 'नहीं',
    ...
    'ride_continue_or_cancel': {
      'en': 'Please continue the ride or cancel it first',
      'hi': 'कृपया सवारी जारी रखें या पहले इसे रद्द करें',
      'te': 'దయచేసి రైడ్‌ను కొనసాగించండి లేదా ముందుగా దాన్ని రద్దు చేయండి',
    },
    'ride_check': {
      'en': 'Ride Check',
      'hi': 'सवारी की जाँच',
    ...
    'call_emergency': {
      ...
      'hi': '112 पर कॉल करें (आपातकालीन)',
      'te': '112 కి కాల్ చేయండి (అత్యవసర)',
    },
    'common_cancel': {
      'en': 'Cancel',
      'hi': 'रद्द करें',
    ...
    'calling_support': {
      'en': 'Calling UGO Support...',
      'hi': 'UGO सहायता को कॉल किया जा रहा है...',
      'te': 'UGO సపోర్ట్‌కి కాల్ చేస్తోంది...',
    },
    'call_support': {
      'en': 'Call Support',
      'hi': 'सहायता को कॉल करें',
      'te': 'సపోర్ట్‌కి కాల్ చేయండి',
    },
    'safety': {
      'en': 'Safety',
      'hi': 'सुरक्षा',
    ...
    'select_vehicle_type': {
      ...
      'te': 'దయచేసి వాహన రకాన్ని ఎంచుకోండి',
    },
    'login_to_use_wallet': {
      'en': 'Please log in to use wallet payment',
      'hi': 'वॉलेट भुगतान का उपयोग करने के लिए कृपया लॉग इन करें',
      'te': 'వాలెట్ చెల్లింపును ఉపయోగించడానికి దయచేసి లాగిన్ చేయండి',
    },
    'wallet_fetch_error': {
    ...
    'payment_success_wallet': {
      ...
      'hi': '✅ भुगतान सफल! वॉलेट अपडेट किया गया।',
      'te': '✅ చెల్లింపు విజయవంతమైంది! వాలెట్ అప్‌డేట్ చేయబడింది.',
    },
    'wallet_update_fail': {
      'en': '❌ Failed to update wallet',
      'hi': '❌ वॉलेट अपडेट करने में विफल',
      'te': '❌ వాలెట్‌ని అప్‌డేట్ చేయడంలో విఫలమైంది',
    },
    'choose_a_ride': {
      'en': 'Choose a ride',
      'hi': 'सवारी चुनें',
    ...
    'add_stop': {
      'en': 'Add stop',
      'hi': 'स्टॉप जोड़ें',
      'te': 'స్టాప్‌ను జోడించు',
    },
    'show_all_rides': {
      'en': 'Show all rides',
      'hi': 'सभी सवारी दिखाएं',
      'te': 'అన్ని రైడ్‌లను చూపించు',
    },
    'pro_label': {
      'en': 'PRO',
      'hi': 'पीआरओ',
    ...
    'comfy_label': {
      'en': 'Comfy • Top Drivers',
      'hi': 'आरामदायक • शीर्ष चालक',
      'te': 'కంఫీ • టాప్ డ్రైవర్లు',
    },
    'offers_label': {
      'en': 'Offers',
      'hi': 'ऑफर',
    ...
    'max_stops_allowed': {
      'en': 'Maximum 3 stops allowed',
      'hi': 'अधिकतम 3 स्टॉप की अनुमति है',
      'te': 'గరిష్టంగా 3 స్టాప్‌లు అనుమతించబడతాయి',
    },
    'could_not_launch_phone': {
      'en': 'Could not launch phone app',
      'hi': 'फ़ोन ऐप लॉन्च नहीं किया जा सका',
      'te': 'ఫోన్ యాప్‌ను ప్రారంభించలేకపోయాము',
    },
    'wallet_updated_balance': {
      'en': 'Wallet Updated: ₹',
      'hi': 'वॉलेट अपडेट किया गया: ₹',
      'te': 'వాలెట్ అప్‌డేట్ చేయబడింది: ₹',
    },
    'payment_failed': {
      'en': 'Payment Failed',
      'hi': 'भुगतान विफल',
    ...
    'share_otp_driver': {
      'en': 'Share OTP with Driver',
      'hi': 'ड्राइवर के साथ ओटीपी साझा करें',
      'te': 'డ్రైవర్‌తో OTP ని షేర్ చేయండి',
    },
    'complete_profile': {
      'en': 'Complete Profile',
      'hi': 'प्रोफ़ाइल पूरी करें',
      'te': 'ప్రొఫైల్‌ను పూర్తి చేయండి',
    },
    'first_name_required': {
      'en': 'First Name is required',
      'hi': 'पहला नाम आवश्यक है',
      'te': 'మొదటి పేరు తప్పనిసరి',
    },
    'email_required': {
      'en': 'Email is required',
      'hi': 'ईमेल आवश्यक है',
      'te': 'ఇమెయిల్ తప్పనిసరి',
    },
    'initializing_wait': {
      'en': 'Initializing... please wait',
      'hi': 'आरंभ किया जा रहा है... कृपया प्रतीक्षा करें',
      'te': 'ప్రారంభిస్తోంది... దయచేసి వేచి ఉండండి',
    },
    'welcome_to_ugo': {
      'en': 'Welcome to UGO!',
      'hi': 'UGO में आपका स्वागत है!',
      'te': 'UGOకి స్వాగతం!',
    },
    'tap_to_add_photo': {
      'en': 'Tap to add photo',
      'hi': 'फ़ोटो जोड़ने के लिए टैप करें',
      'te': 'ఫోటోను జోడించడానికి నొక్కండి',
    },
    'photo_selected': {
      'en': 'Photo selected',
      'hi': 'फ़ोटो चयनित',
      'te': 'ఫోటో ఎంపిక చేయబడింది',
    },
    'first_name_label': {
      'en': 'First name *',
      'hi': 'पहला नाम *',
    ...
    'finding_ride': {
      'en': 'Finding your ride',
      'hi': 'आपकी सवारी ढूँढ रहे हैं',
      'te': 'మీ రైడ్‌ని కనుగొంటున్నాము',
    },
    'your_ride': {
      'en': 'Your ride',
      'hi': 'आपकी सवारी',
    ...
    'ride_cancel_dialog_title': {
      'en': 'Cancel Ride?',
      'hi': 'सवारी रद्द करें?',
      'te': 'రైడ్‌ని రద్దు చేయాలా?',
    },
    'ride_cancel_dialog_text': {
      'en': 'Are you sure you want to cancel this ride?',
      'hi': 'क्या आप वाकई इस सवारी को रद्द करना चाहते हैं?',
      'te': 'మీరు నిజంగా ఈ రైడ్‌ని రద్దు చేయాలనుకుంటున్నారా?',
    },
    'no': {
      'en': 'No',
      'hi': 'नहीं',
    ...
    'ride_cancel_failed': {
      'en': 'Failed to cancel ride.',
      'hi': 'सवारी रद्द करने में विफल।',
      'te': 'రైడ్‌ను రద్దు చేయడంలో విఫలమైంది.',
    },
    'ride_back_restriction': {
      'en': 'Please continue the ride or cancel it first',
      'hi': 'कृपया सवारी जारी रखें या पहले इसे रद्द करें',
      'te': 'దయచేసి రైడ్‌ను కొనసాగించండి లేదా ముందుగా దానిని రద్దు చేయండి',
    },
    'ride_check_title': {
      'en': 'Ride Check',
      'hi': 'सवारी जांच',
    ...
    'ride_check_text': {
      'en': 'Are you okay? Your ride is going smoothly.',
      'hi': 'क्या आप ठीक हैं? आपकी सवारी सुचारू रूप से चल रही है।',
      'te': 'మీరు బాగున్నారా? మీ రైడ్ సజావుగా సాగుతోంది.',
    },
    'ride_check_help': {
      'en': 'I need help',
      'hi': 'मुझे मदद चाहिए',
    ...
    'val_select_vehicle': {
      'en': 'Please select a vehicle type',
      'hi': 'कृपया वाहन का प्रकार चुनें',
      'te': 'దయచేసి వాహనం రకాన్ని ఎంచుకోండి',
    },
    'val_login_wallet': {
      'en': 'Please log in to use wallet payment',
      'hi': 'वॉलेट भुगतान का उपयोग करने के लिए कृपया लॉग इन करें',
    ...
    'payment_success_wallet': {
      'en': 'Payment successful! Wallet updated.',
      'hi': 'भुगतान सफल! वॉलेट अपडेट हो गया।',
      'te': 'చెల్లింపు విజయవంతమైంది! వాలెట్ నవీకరించబడింది.',
    },
    'payment_failed_wallet': {
      'en': 'Failed to update wallet',
      'hi': 'वॉलेट अपडेट करने में विफल',
      'te': 'వాలెట్‌ని నవీకరించడంలో విఫలమైంది',
    },
    'choose_ride_title': {
      'en': 'Choose a ride',
      'hi': 'सवारी चुनें',
      'te': 'రైడ్‌ని ఎంచుకోండి',
    },
    'ride_stops_label': {
      'en': 'Stops',
      'hi': 'स्टॉप',
    ...
    'no_rides_available': {
      ...
      'hi': 'कोई सवारी उपलब्ध नहीं है',
      'te': 'రైడ్‌లు అందుబాటులో లేవు',
    },
    'try_where_to_go': {
      'en': 'Try "Where to go?" for all options',
      'hi': 'सभी विकल्पों के लिए "कहाँ जाना है?" आज़माएँ',
      'te': 'అన్ని ఎంపికల కోసం "ఎక్కడికి వెళ్లాలి?" ప్రయత్నించండి',
    },
    'show_all_rides': {
      'en': 'Show all rides',
      'hi': 'सभी सवारी दिखाएं',
    ...
    'leave_session': {
      'en': 'Leave the app session',
      'hi': 'ऐप सत्र छोड़ें',
      'te': 'యాప్ సెషన్ నుండి నిష్క్రమించండి',
    },
    'val_payment_start_fail': {
      'en': 'Could not start payment',
      'hi': 'भुगतान शुरू नहीं हो सका',
      'te': 'చెల్లింపును ప్రారంభించడం సాధ్యపడలేదు',
    },
    'wallet_updated_success': {
      'en': 'Wallet Updated',
      'hi': 'वॉलेट अपडेट हो गया',
      'te': 'వాలెట్ నవీకరించబడింది',
    },
    'wallet_update_failed': {
      'en': 'Wallet update failed',
      'hi': 'वॉलेट अपडेट विफल रहा',
      'te': 'వాలెట్ నవీకరణ విఫలమైంది',
    },
    'payment_failed': {
      'en': 'Payment Failed',
      'hi': 'भुगतान विफल',
    ...
    'val_amount_required': {
      ...
      'te': 'దయచేసి మొత్తాన్ని నమోదు చేయండి',
    },
    'val_amount_invalid': {
      'en': 'Enter valid amount',
      'hi': 'मान्य राशि दर्ज करें',
      'te': 'చెల్లుబాటు అయ్యే మొత్తాన్ని నమోదు చేయండి',
    },
    'add_amount_button': {
      'en': 'Add Amount',
      'hi': 'राशि जोड़ें',
      'te': 'మొత్తాన్ని జోడించండి',
    },
    'settings_title': {
      'en': 'App Settings',
      'hi': 'ऐप सेटिंग्स',
