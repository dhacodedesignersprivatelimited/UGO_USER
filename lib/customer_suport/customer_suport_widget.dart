  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Scaffold(
        key: scaffoldKey,
        backgroundColor:
            const Color(0xFFF8F9FA), // Cleaner, brighter background
        appBar: AppBar(
        ...
        body: _isLoading
            ? const Center(
                child: CircularProgressIndicator(color: Color(0xFFFF7B10)))
                          ...
                          child: Container(
                            decoration: BoxDecoration(
                              ...
                              boxShadow: [
                                BoxShadow(
                                  color:
                                      const Color(0xFFFF7B10).withOpacity(0.3),
                                  blurRadius: 15,
                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          _buildHelpTile(Icons.local_taxi_rounded,
                              'Safety & Driver Feedback'),
                          _buildHelpTile(
                              Icons.receipt_long_rounded, 'Payment & Refunds'),
                          _buildHelpTile(
                              Icons.luggage_rounded, 'I lost an item'),
                        ],
                      ),
                    ),
      ...
      child: ListTile(
        ...
        onTap: () {
          ...
          Navigator.push(
            ...
            MaterialPageRoute(
                builder: (context) =>
                    const AiChatWidget()), // In the future, pass initialMsg: title
          );
        },
      ),
    );
